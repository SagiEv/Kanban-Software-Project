...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    /// {
    ///     "ErrorMessage": &lt;string&gt;,
    ///     "ReturnValue": &lt;object&gt;xssssssssssssssssssssssssssssssssssssssssssssssssssssss
    /// }
    /// </code>
    /// Where:
    /// <list type="bullet">
    ...
    {  
        ...
        {
            //this.ss = new UserService();
            //this.taskService = new TaskService();
            //this.boardService = new BoardService(ss);
        ...
        {
            return systemService.Register(email, password);
        }
        ...
        {
            return systemService.Logout(email);
        }
        ...
        public string LimitColumn(string email, string boardName, int columnOrdinal, int limit)
        {
            ...
            return systemService.LimitColumn(email, boardName, columnOrdinal, limit);
        }
        ...
        {
            return systemService.GetColumnLimit(email, boardName, columnOrdinal);
        }
        ...
        {
            return systemService.GetColumnName(email, boardName, columnOrdinal);
        }
        ...
        {
            return systemService.AddTask(email, boardName, title, description, dueDate);
        }
        ...
        {
            return systemService.AddTask(email, boardName, title, dueDate);
        }
        ...
        {
            return systemService.UpdateTaskDueDate(email, boardName, columnOrdinal, taskId, dueDate);
        }
        ...
        {
            return systemService.UpdateTaskTitle(email, boardName, columnOrdinal, taskId, title);
        }
        ...
        {
            return systemService.UpdateTaskDescription(email, boardName, columnOrdinal, taskId, description); 
        }
        ...
        {
            return systemService.AdvanceTask(email, boardName, columnOrdinal, taskId);  
        }
        ...
        {
            return systemService.GetColumn(email, boardName, columnOrdinal);
        }
        ...
        {
            return systemService.CreateBoard(email, name); 
        }
        ...
        {
            return systemService.DeleteBoard(email, name);
        }
        ...
        {
            return systemService.InProgressTasks(email);
        }
        ...
        {
            return systemService.GetUserBoards(email);
        }
        ...
        {
            return systemService.JoinBoard(email,boardID);
        }
        ...
        {
            return systemService.LeaveBoard(email, boardID);
        }
        ...
        {
            return systemService.AssignTask(email,boardName,columnOrdinal,taskID,emailAssignee);
        }
        ...
        {
            return systemService.GetBoardName(boardId);
        }
        ...
        {
            return systemService.TransferOwnership(currentOwnerEmail,newOwnerEmail,boardName);
        }
        ...
        {
            return systemService.DeleteData();
        }
